...
(function ($) {
    ...
    $.fn.simpleCropper = function (onComplete) {
        ...
        if(windowScreenWidth > 768) {
            ...
            var image_dimension_x = 280;
            var image_dimension_y = 280;
        }
        var scaled_width = 0;
        var scaled_height = 0;
        var x1 = 0;
        ...
        this.click(function () {
            // aspX = $(this).width();
            // aspY = $(this).height();
            aspX = $(this).attr("datawidth") * 10;
            aspY = $(this).attr("dataheight") * 10;
        ...
        function preview() {
            ...
            var editIcon = '<div style="background:#cffafe;padding:0.5rem; position: absolute;top: 0;right: 0;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path fill="none" d="M0 0h24v24H0z"/><path d="M15.728 9.686l-1.414-1.414L5 17.586V19h1.414l9.314-9.314zm1.414-1.414l1.414-1.414-1.414-1.414-1.414 1.414 1.414 1.414zM7.242 21H3v-4.243L16.435 3.322a1 1 0 0 1 1.414 0l2.829 2.829a1 1 0 0 1 0 1.414L7.243 21z"/></svg></div>';
            file_display_area.append(imageFoo);
            file_display_area.append(editIcon);
        ...
        $(window).resize(function () {
            ...
            var window_width = $(window).width() / 2 - scaled_width / 2 + "px";
            var window_height = $(window).height() / 2 - scaled_height / 2 + "px";
            // var window_width = scaled_width / 2 + "px";
            // var window_height = scaled_height / 2 + "px";
